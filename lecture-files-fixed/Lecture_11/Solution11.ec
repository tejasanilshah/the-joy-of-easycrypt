...
(* Some useful lemma *)
(*
TODO: Since we clone finite, we already get this lemma for "free"
We can do away with this lemma.
*)

(* lemma card_pr t': mu CTS.dunifin (fun (y : C) => y = t') = 1%r / cardC%r. *)
(* proof. *)
(*   rewrite (_: (fun (y : C) => y = t') = (=) t'). *)
(*   apply fun_ext; smt. *)
(*   have H1: mu_x CTS.dunifin t' = 1%r / cardC%r. *)
(*     smt. *)
(*   smt. *)
(* qed. *)
